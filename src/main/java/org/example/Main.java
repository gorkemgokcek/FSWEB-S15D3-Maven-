...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        employees.add(new Employee(1, "Ahmet", "Işık"));
        employees.add(new Employee(1, "Ahmet", "Işık"));
        employees.add(new Employee(2, "Selim", "Yılmaz"));
        employees.add(new Employee(2, "Selim", "Yılmaz"));
        employees.add(new Employee(3, "Mehmet", "Dursun"));
        employees.add(new Employee(4, "Gorkem", "Gokcek"));
        employees.add(new Employee(4, "Gorkem", "Gokcek"));
